...
const OFFICIAL_SHELL_STYLES = '<link rel="stylesheet" href="/assets/contact-official-shell.css?v=20"/>';
const OFFICIAL_SHELL_SCRIPT = '<script src="/assets/contact-official-shell.js?v=14" defer></script>';
