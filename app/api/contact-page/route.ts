...
const OFFICIAL_SHELL_STYLES = '<link rel="stylesheet" href="/assets/contact-official-shell.css?v=10"/>';
const OFFICIAL_SHELL_SCRIPT = '<script src="/assets/contact-official-shell.js?v=7" defer></script>';
