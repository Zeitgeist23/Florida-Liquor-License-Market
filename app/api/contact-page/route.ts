...
const OFFICIAL_HEADER = `<header class="site-header forms-site-header page-shell fllm-official-contact-header">
  ...
  <nav class="primary-nav" aria-label="Primary navigation">
    ...
    <div class="native-nav-dropdown" data-nav-menu="sell"><button class="native-nav-trigger" type="button" aria-haspopup="menu" aria-expanded="false"><span>Sell</span><img class="nav-chevron" src="/assets/nav-chevron.png" alt="" aria-hidden="true"/></button><div class="native-nav-menu native-nav-menu-standard" role="menu" aria-label="Sell menu"><a href="/brokers/advertise-client-liquor-license" role="menuitem">BROKERS — See Featured Listing Example</a><a href="/brokers/list-your-license" role="menuitem">BROKERS — List a Client License</a><a href="/sell-your-license" role="menuitem">Sell Your License</a><a href="/how-to-sell-florida-liquor-license" role="menuitem">How to Sell a Florida Liquor License</a><a href="/florida-liquor-license-value" role="menuitem">Get a License Valuation</a></div></div>
