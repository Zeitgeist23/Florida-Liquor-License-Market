...
const menuMarkup = `<div class="home-list-license-wrap" data-home-list-license-menu="true">
  <a class="btn btn-gold home-list-license-trigger" href="${SELF_DIRECTED_PATH}">List Your License</a>
...
function injectListLicenseMenu(html: string) {
  ...
  if (!updated.includes(marker)) {
    const buttonPattern = /<a\b(?=[^>]*class="[^"]*\bbtn\b[^"]*\bbtn-gold\b[^"]*")(?=[^>]*href="#sell")[^>]*>\s*List Your License\s*<\/a>/i;
