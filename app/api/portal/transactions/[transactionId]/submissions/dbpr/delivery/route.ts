...
import { recordDbprDelivery } from "@/lib/portal-agency-submission";
import {
...
export async function POST(
  ...
  try {
    ...
    const result = await recordDbprDelivery({
      user,
      transaction,
      method: body.method,
    ...
    const message = error instanceof Error ? error.message : "The DBPR delivery record could not be saved.";
