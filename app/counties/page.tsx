...
export const metadata: Metadata = {
  ...
  description:
    "Compare Florida liquor license asking prices, active 4COP and 3PS inventory, county populations, and 2026 quota drawing availability across all 67 Florida counties.",
  ...
  openGraph: {
    ...
    description: "Compare current 4COP and 3PS asking-price data, active inventory, population and DBPR quota drawing data across Florida's 67 counties.",
    ...
    <main className="county-directory-page market-data-page">
      ...
      <section className="directory-hero market-data-hero">
        <div className="directory-shell">
          ...
          <p>Compare current 4COP and 3PS asking prices, active marketplace inventory, county populations and 2026 DBPR quota drawing availability across all 67 Florida counties.</p>
        ...
        <div className="directory-shell">
          ...
          <div className="market-table-wrap">
            <table className="market-data-table">
              <thead><tr><th>County</th><th>2024 Population</th><th>Active Listings</th><th>4COP Asking Market</th><th>3PS Asking Market</th><th>2026 New Quota</th></tr></thead>
              <tbody>
                {countyRows.map((row) => (
          ...
          <p className="market-table-footnote">The 2026 quota column reflects licenses listed in the official DBPR Quota Beverage License Drawing notice. Selection establishes priority to apply; it does not itself issue a beverage license.</p>
        </div>
      </section>
      ...
      <section className="market-methodology directory-shell">
        ...
        <div className="methodology-grid">
          ...
          <article><b>03</b><strong>Quota drawing availability</strong><p>2026 availability is taken from the Florida DBPR Division of Alcoholic Beverages and Tobacco&apos;s official drawing notice, verified {QUOTA_DRAWING_2026.lastVerified}.</p><a href={QUOTA_DRAWING_2026.sourceNoticeUrl} target="_blank" rel="noopener noreferrer">Official 2026 DBPR Notice ↗</a></article>
          <article><b>04</b><strong>Regulatory reference</strong><p>License issuance and transfer requirements remain governed by Florida law and DBPR/ABT. Market data does not replace independent legal, regulatory or financial diligence.</p><a href={QUOTA_DRAWING_2026.quotaInformationUrl} target="_blank" rel="noopener noreferrer">DBPR Quota License Information ↗</a></article>
        </div>
      </section>
