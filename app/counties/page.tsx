  ...
  return (
    <main className="county-directory-page">
      ...
      <header className="directory-header directory-shell">
        ...
        <nav><Link href="/listings">All Listings</Link><Link href="/financing">Financing</Link><Link href="/sell-your-license">List Your License</Link><Link href="/contact">Contact</Link></nav>
      </header>
      ...
      <section className="directory-featured directory-shell">
        <div className="directory-heading"><div><span>High-Interest Markets</span><h2>Featured Florida Counties</h2></div><Link href="/listings">Search all inventory ›</Link></div>
      ...
      <section className="directory-cta">
        <div className="directory-shell directory-cta-grid">
          <div><span>For Buyers</span><h2>Search current license opportunities</h2><p>Filter statewide inventory by county, license type, price, and availability.</p><Link href="/listings">Browse Listings</Link></div>
      ...
      <footer className="directory-footer"><div className="directory-shell"><span>© Florida Liquor License Market</span><nav><Link href="/">Home</Link><Link href="/listings">Listings</Link><Link href="/financing">Financing</Link><Link href="/contact">Contact</Link></nav></div></footer>
    </main>
  );
}
