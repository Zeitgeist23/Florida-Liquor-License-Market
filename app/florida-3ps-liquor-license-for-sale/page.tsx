  ...
  return (
    <>
      ...
      <main className="three-ps-page">
        ...
        <footer className="three-ps-footer"><div className="three-ps-shell"><Link className="three-ps-footer-brand" href="/"><img src="/assets/brand-sharp.svg" alt="Florida Liquor License Market" /></Link><p>A more transparent market for Florida liquor-license buyers, sellers and professionals.</p><nav><Link href="/listings">Listings</Link><Link href="/counties">County Markets</Link><Link href="/license-types/3ps-package-store">3PS Guide</Link><Link href="/how-to-buy-florida-liquor-license">How to Buy</Link><Link href="/brokers/list-your-license">Broker Advertising</Link><Link href="/financing">Financing</Link><Link href="/contact">Contact</Link></nav><small>© {new Date().getFullYear()} Florida Liquor License Market. All rights reserved.</small></div></footer>
      </main>
    </>
  );
}
