...
export default function Page() {
  return <LicenseTypeExplainerPage
    ...
    imageSrc="/assets/license-types-3ps.svg"
    imageAlt="Liquor store interior representing package-store businesses that commonly use a Florida 3PS quota liquor license"
