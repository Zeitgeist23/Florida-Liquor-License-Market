...
export default function Page() {
  return <LicenseTypeExplainerPage
    ...
    requirementCards={[
      { label: "Food-sales requirement", value: "No statewide SRX 51% test", detail: "A quota 4COP is not conditioned on the special restaurant 51% food-and-nonalcoholic-beverage revenue test merely because it is a 4COP quota license." },
      { label: "Minimum service area", value: "No SRX 2,000 sq. ft. minimum", detail: "There is no general statewide 2,000-square-foot restaurant qualification merely to hold a quota 4COP. Local premises, building, fire and zoning rules still apply." },
      { label: "Minimum seating", value: "No SRX 120-seat minimum", detail: "The special restaurant seating threshold does not define eligibility for a standard transferable quota 4COP. Occupancy and local use approvals remain separate issues." },
      { label: "Core privilege", value: "Beer · wine · spirits", detail: "Full-liquor consumption-on-premises privileges may be paired with package sales within the approved quota-license series and premises configuration." }
    ]}
    ...
    ruleUpdateLinks={[
      {
        ...
        description: "See the statewide reform that reduced the SFS/SRX restaurant size and seating thresholds while preserving the revenue test."
      },
      {
        ...
        description: "Review the current food-order, sealing, packaging and delivery rules that can matter to qualifying restaurant operations."
      }
    ]}
    researchLinks={[
      {
