...
export default function Page() {
  return <>
    <LicenseTypeExplainerPage
      ...
      businesses={["Bars and taverns", "Cocktail lounges", "Nightclubs", "Gentlemen's clubs", "Marinas", "Sports bars", "Country clubs", "Lounges", "Pubs", "Breweries", "Full-liquor hospitality concepts", "Restaurants that need a transferable quota license instead of a special restaurant license"]}
