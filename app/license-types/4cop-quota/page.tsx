...
export default function Page() {
  return <LicenseTypeExplainerPage
    ...
    requirementCards={[
      { label: "Food-sales requirement", value: "No statewide SRX 51% test", detail: "A quota 4COP is not conditioned on the special restaurant 51% food-and-nonalcoholic-beverage revenue test merely because it is a 4COP quota license.", href: "https://www.myfloridalicense.com/CheckListDetail.asp?SID=&XACT_DEFN_ID=7048&clientCode=4006&xactCode=1065", linkLabel: "Official 4COP checklist ↗" },
      { label: "Minimum service area", value: "No SRX 2,000 sq. ft. minimum", detail: "There is no general statewide 2,000-square-foot restaurant qualification merely to hold a quota 4COP. Local premises, building, fire and zoning rules still apply.", href: "https://www.myfloridalicense.com/CheckListDetail.asp?SID=&XACT_DEFN_ID=7048&clientCode=4006&xactCode=1065", linkLabel: "Official 4COP checklist ↗" },
      ...
      { label: "Core privilege", value: "Beer · wine · spirits", detail: "Full-liquor consumption-on-premises privileges may be paired with package sales within the approved quota-license series and premises configuration.", href: "https://www2.myfloridalicense.com/abt/rules_statutes/license_types.pdf", linkLabel: "Official ABT license types ↗" }
    ]}
    ...
    officialResources={[
      { href: "https://www.myfloridalicense.com/CheckListDetail.asp?SID=&XACT_DEFN_ID=7048&clientCode=4006&xactCode=1065", label: "DBPR / ABT 4COP Quota Checklist", description: "Official application and qualification checklist for the 4COP quota consumption-on-premises category." },
      { href: "https://www.leg.state.fl.us/statutes/index.cfm?App_mode=Display_Statute&URL=0500-0599%2F0561%2FSections%2F0561.20.html", label: "Florida Statute §561.20 — Quota System", description: "Read the statewide quota-license limitation and statutory exceptions directly from the Florida Legislature." },
      { href: "https://www.leg.state.fl.us/statutes/index.cfm?App_mode=Display_Statute&URL=0500-0599%2F0561%2FSections%2F0561.17.html", label: "Florida Statute §561.17 — Premises & Applications", description: "Official application, premises and occupancy-documentation requirements that can affect an operating location." },
      { href: "/dbpr-abt-6002", label: "FLLM ABT-6002 Transfer Guide", description: "Use FLLM's application-center explanation of the DBPR transfer application used in liquor-license transactions." }
    ]}
    ...
    researchLinks={[
      { href: "/resources/florida-liquor-license-laws#cocktails-to-go", label: "Cocktails-to-Go Statutes", description: "Open SB 148, section 565.045, and the related open-container provision." },
