...
export default function Page() {
  return <LicenseTypeExplainerPage
    ...
    requirementCards={[
      { label: "Food & nonalcoholic revenue", value: "At least 51%", detail: "The qualifying restaurant must generally derive at least 51% of gross food-and-beverage revenue from food and nonalcoholic beverages under the current statewide special food service framework.", href: "https://www.leg.state.fl.us/statutes/index.cfm?App_mode=Display_Statute&URL=0500-0599%2F0561%2FSections%2F0561.20.html", linkLabel: "Current statute ↗" },
      { label: "Minimum service area", value: "At least 2,000 sq. ft.", detail: "Current statewide law generally requires at least 2,000 square feet of service area for the qualifying special food service establishment.", href: "https://www.leg.state.fl.us/statutes/index.cfm?App_mode=Display_Statute&URL=0500-0599%2F0561%2FSections%2F0561.20.html", linkLabel: "Current statute ↗" },
      { label: "Meal-service capacity", value: "120 people at one time", detail: "The establishment must generally be equipped to serve meals to at least 120 persons at one time under the current statewide standard.", href: "https://www.myfloridalicense.com/CheckListDetail.asp?SID=&XACT_DEFN_ID=7059&clientCode=4006&xactCode=1034", linkLabel: "Official SFS checklist ↗" },
      { label: "Physical seating", value: "At least 120 seats", detail: "The current statewide framework generally requires at least 120 physical seats, subject to applicable law and any special local act.", href: "https://www2.myfloridalicense.com/abt/documents/General_Laws_and_Special_Acts_for_Food_Service_Establishments.pdf", linkLabel: "ABT general & special acts ↗" }
    ]}
    ...
    officialResources={[
      { href: "https://www.myfloridalicense.com/CheckListDetail.asp?SID=&XACT_DEFN_ID=7059&clientCode=4006&xactCode=1034", label: "DBPR / ABT 4COP-SFS Checklist", description: "Official qualification checklist for Florida's special full-liquor food-service restaurant license." },
      { href: "https://www.leg.state.fl.us/statutes/index.cfm?App_mode=Display_Statute&URL=0500-0599%2F0561%2FSections%2F0561.20.html", label: "Florida Statute §561.20 — Special Restaurant Exception", description: "Read the current general-law restaurant exception and quota-license framework directly from the Florida Legislature." },
      { href: "https://www2.myfloridalicense.com/abt/documents/General_Laws_and_Special_Acts_for_Food_Service_Establishments.pdf", label: "ABT General Laws & Special Acts for Food Service", description: "DBPR's county and local-act reference for restaurant licensing variations, including special qualification rules." },
      { href: "/resources/forms", label: "FLLM Florida ABT Forms Center", description: "Open FLLM's organized application and licensing forms for Florida alcoholic-beverage transactions." }
    ]}
    ...
    researchLinks={[
      { href: "/resources/florida-liquor-license-laws#current-developments", label: "Florida Liquor License Laws", description: "Open the statewide statute, official DBPR sources and the connected Orlando special acts." },
