...
export default function Page() {
  return (
    <LicenseTypeExplainerPage
      ...
      keyPoint="In a gentlemen's-club transaction, the operating business and the 4COP quota license do not have to be marketed as one inseparable asset. A broker may market the business package through the broker's normal channels while separately exposing the county-specific 4COP quota license to liquor-license buyers—provided the listing accurately describes what is and is not included in the transaction."
