...
export default function ExchangeStaticClient({ marketSnapshot, tickerListings }: ExchangeStaticClientProps) {
  ...
  const toolCards = [
    ...
    { title: "Market Data", description: "Live market data, historical trends, and pricing insights.", action: "VIEW MARKET DATA →", href: "/market-data", artLeft: "-33.45vw", artTop: "-99.12vw" },
    { title: "County Heat Maps", description: "Explore license availability and market activity by county.", action: "VIEW COUNTY MAPS →", href: "/counties", artLeft: "-49.08vw", artTop: "-99.12vw" },
    { title: "Appraisals & Valuation", description: "Get a professional liquor license valuation.", action: "GET A VALUATION →", href: "/florida-liquor-license-appraisal", artLeft: "-64.8vw", artTop: "-99.12vw" },
    { title: "License Types", description: "Learn about 4COP, 3PS and more.", action: "BROWSE LICENSE TYPES →", href: "/resources/florida-liquor-license-types", artLeft: "-80.43vw", artTop: "-99.12vw" },
    { title: "Financing a License", description: "Explore financing options and connect with lenders.", action: "VIEW FINANCING →", href: "/financing", artLeft: "-2.4vw", artTop: "-112.7vw" },
    { title: "FLLM News", description: "Market trends, analysis, and industry updates.", action: "VIEW NEWS →", href: "/florida-liquor-license-news", artLeft: "-17.93vw", artTop: "-112.7vw" },
    { title: "Featured Broker Listings", description: "Hand-selected broker opportunities.", action: "VIEW BROKER LISTINGS →", href: "/listings", artLeft: "-33.45vw", artTop: "-112.7vw" },
    { title: "Attorney Directory", description: "Find experienced Florida liquor license attorneys.", action: "FIND AN ATTORNEY →", href: "/resources/liquor-license-attorneys", artLeft: "-49.08vw", artTop: "-112.7vw" },
    { title: "Resources & Guides", description: "Regulations, transfer process, FAQs and educational content.", action: "VIEW RESOURCES →", href: "/resources", artLeft: "-64.8vw", artTop: "-112.7vw" },
    { title: "Investment Opportunities", description: "Explore high-growth markets and investment insights.", action: "VIEW OPPORTUNITIES →", href: "/invest", artLeft: "-80.43vw", artTop: "-112.7vw" },
  ];
