  ...
  return (
    <main className="exchange-static-page">
      <style>{`
        ...
        .hero-market-sign{position:absolute;z-index:4;left:91.25%;top:5.7%;display:grid;align-content:center;gap:.38vw;width:8.05%;height:49.2%;padding:.55vw .58vw .45vw .86vw;clip-path:polygon(10% 0,92% 3%,100% 100%,0 100%);background:linear-gradient(100deg,#061522,#03111d 72%,#061421);box-shadow:inset 0 0 0 1px #17536e;color:#eef4f7;transform:rotate(.8deg);transform-origin:center;font-size:clamp(6px,.55vw,10.5px);font-weight:800;line-height:1.08;text-transform:uppercase;text-shadow:0 1px 1px #000}
        .hero-market-sign span{display:block;white-space:nowrap}
        ...
        .exchange-news-row{display:grid;grid-template-columns:23.5% 53% 23.5%;height:18.7vw;min-height:200px;padding:.45vw .75vw;background:#031421;border-bottom:2px solid #b88612}.news-copy-panel,.news-headlines{border:1px solid #17678d;background:#04182a}.news-copy-panel{padding:1vw;background:radial-gradient(ellipse at 92% 84%,rgba(22,130,219,.3),transparent 33%),linear-gradient(180deg,#04182a 0%,#05213d 67%,#0a4f8d 71%,#063765 75%,#0b5a9c 79%,#06345f 84%,#04182a 100%)}.news-copy-panel h2{margin:0;color:#ffbd22;font-size:clamp(15px,1.55vw,29px)}.news-copy-panel p{margin:1.5vw 0;color:#e5edf1;font-size:clamp(9px,.82vw,16px);line-height:1.45}.news-copy-panel .outline-button{width:77%;padding:0;min-height:clamp(30px,2.55vw,48px)}.news-art-crop{position:relative;overflow:visible;border-block:1px solid #17678d}.news-image-clip{position:absolute;inset:0;overflow:hidden}.news-image-clip>img{position:absolute;left:-44.86%;top:-344%;width:191.4%;max-width:none;height:auto}.news-network-mark{position:absolute;z-index:2;left:36%;top:3.5%;display:flex;align-items:center;justify-content:center;gap:.65vw;width:28%;height:21%;background:transparent}.news-network-mark img{width:18%;height:82%;object-fit:contain;filter:grayscale(1) sepia(1) saturate(7) hue-rotate(355deg) brightness(1.55) drop-shadow(0 0 5px #ffbd22)}.news-network-copy{display:grid;text-align:center;line-height:1}.news-network-copy strong{color:#ffe19a;font:700 clamp(22px,2.35vw,45px)/.85 Georgia,'Times New Roman',serif;letter-spacing:.08em;text-shadow:0 0 8px #ffb71c}.news-network-copy small{margin-top:.25vw;color:#fff;font-size:clamp(8px,.72vw,14px);font-weight:950;letter-spacing:.04em}.news-lower-third{position:absolute;z-index:3;left:-4.75vw;right:0;bottom:1%;display:grid;grid-template-columns:12.5% 1fr 25%;align-items:stretch;height:20%;border-top:2px solid #37c9ff;border-bottom:2px solid #074985;background:#07316a;box-shadow:0 -4px 14px rgb(13 133 255/.45)}.news-lower-label{display:grid;place-items:center;padding:0 .3vw;background:#073f8d;color:#ffbd22;text-align:center;font-size:clamp(7px,.72vw,14px);font-weight:950;line-height:1.05}.news-lower-copy{display:grid;align-content:center;padding:0 .8vw;background:linear-gradient(112deg,#f8fbff 0%,#e9f8ff 62%,#24adff 100%);color:#06214a}.news-lower-copy strong{font-size:clamp(10px,1.12vw,21px);line-height:1.05}.news-lower-copy small{margin-top:.18vw;font-size:clamp(6px,.57vw,11px);font-weight:800}.news-lower-right{display:grid;place-content:center;padding:0 .6vw;background:linear-gradient(110deg,#178ee2,#07498f);color:#fff;text-align:center;font-size:clamp(7px,.72vw,14px);font-weight:950;line-height:1.2}.news-headlines{padding:.7vw}.news-headlines header{display:flex;justify-content:space-between;gap:.5vw;margin-bottom:.55vw}.news-headlines b{font-size:clamp(9px,.75vw,14px)}.news-headlines header a{color:#28d7ff;font-size:clamp(8px,.65vw,12px);font-weight:900;text-decoration:none}.news-headlines>a{display:grid;grid-template-columns:auto 1fr;gap:.65vw;padding:.42vw 0;border-bottom:1px solid rgba(255,255,255,.08);color:#e8f0f4;text-decoration:none;font-size:clamp(8px,.69vw,13px);line-height:1.25}.news-headlines>a::before{content:'▤';color:#fff;font-size:clamp(15px,1.45vw,28px)}
        ...
        .news-copy-panel{background:radial-gradient(ellipse at 90% 100%,rgba(20,114,196,.42),transparent 54%),linear-gradient(180deg,#04182a 0%,#05203b 64%,#07325c 72%,#094b82 78%,#06345f 85%,#04182a 100%)}
        .news-network-mark{left:34%;width:32%;height:24%;background:transparent;isolation:isolate}.news-network-mark::before{content:'';position:absolute;z-index:-1;inset:-12% -10% -48%;background:rgba(1,38,85,.18);backdrop-filter:blur(18px) saturate(.8);-webkit-backdrop-filter:blur(18px) saturate(.8);mask-image:radial-gradient(ellipse at 50% 42%,#000 45%,transparent 100%);-webkit-mask-image:radial-gradient(ellipse at 50% 42%,#000 45%,transparent 100%)}.news-network-mark img{filter:grayscale(1) sepia(1) saturate(7) hue-rotate(355deg) brightness(1.35) drop-shadow(0 0 4px rgba(255,189,34,.75))}.news-network-copy strong{color:#f7d88b;font-size:clamp(21px,2.15vw,41px);text-shadow:0 0 5px rgba(255,183,28,.65)}
        .news-network-copy{position:relative}.news-network-copy strong,.news-network-copy small{position:relative;z-index:1}.news-network-copy::after{content:'';position:absolute;z-index:0;left:-22%;right:-22%;top:100%;height:clamp(12px,1.35vw,25px);background:radial-gradient(ellipse at center,rgba(1,38,85,.96) 0%,rgba(1,38,85,.72) 44%,rgba(1,38,85,.2) 68%,transparent 84%);filter:blur(2px)}
        .news-lower-label{position:relative;z-index:4;margin-left:-1px}.news-headlines{display:flex;flex-direction:column}.news-headlines header{flex:0 0 auto}.news-headlines>a{flex:1;align-items:center;padding:.35vw 0;font-size:clamp(9px,.78vw,15px);line-height:1.3}
      ...
      <section className="exchange-live-hero" aria-label="FLLM Exchange trading floor">
        <div className="hero-market-sign" aria-label="FLLM market services">
      ...
      <section className="exchange-market-html" aria-label="FLLM Exchange market overview">
        ...
        <section className="exchange-news-row">
          ...
          <div className="news-art-crop" aria-label="FLLM News Network broadcast">
            <div className="news-image-clip"><img src="/assets/fllm-exchange-landing-page-approved-design.png?v=20260912-1" alt="FLLM News Network broadcast" /></div>
            <div className="news-network-mark" aria-hidden="true"><img src="/assets/florida-map-clean.png" alt="" /><span className="news-network-copy"><strong>FLLM</strong><small>NEWS NETWORK</small></span></div>
            <div className="news-lower-third"><span className="news-lower-label">MARKET<br />INSIGHTS</span><span className="news-lower-copy"><strong>FLORIDA LIQUOR LICENSE MARKET ON THE RISE</strong><small>DEMAND DRIVES STRONG ACTIVITY ACROSS KEY FLORIDA MARKETS</small></span><span className="news-lower-right">REAL OPPORTUNITY.<br />REAL INFORMATION.</span></div>
          </div>
