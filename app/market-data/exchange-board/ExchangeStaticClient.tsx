  ...
  return (
    <main className="exchange-static-page">
      <style>{`
        ...
        @media(max-width:820px){.news-art-crop .news-studio-art{left:0;top:0;width:100%;height:79.4737%}.news-art-crop .news-lower-third-art{left:-8.1482%;top:auto;width:108.1482%;height:20.5263%}}
      `}</style>
      ...
      <section className="exchange-market-html" aria-label="FLLM Exchange market overview">
        ...
        <section className="exchange-news-row">
          ...
          <aside className="news-headlines"><header><b>LATEST HEADLINES</b><a href="/florida-liquor-license-news">VIEW ALL NEWS →</a></header><a href="/florida-liquor-license-news"><span className="news-doc-icon" aria-hidden="true" /><span>Florida Liquor License Prices Show Strong Growth in 2024<br />Apr. 24, 2024</span></a><a href="/florida-liquor-license-news"><span className="news-doc-icon" aria-hidden="true" /><span>New Legislation Could Impact License Transfers<br />Mar. 18, 2024</span></a><a href="/florida-liquor-license-news"><span className="news-doc-icon" aria-hidden="true" /><span>South Florida Leads in New Listings<br />Mar. 10, 2024</span></a><a href="/florida-liquor-license-news"><span className="news-doc-icon" aria-hidden="true" /><span>Financing Options Expand for License Buyers<br />Mar. 02, 2024</span></a></aside>
        </section>
