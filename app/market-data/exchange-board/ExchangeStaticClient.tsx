  ...
  return (
    <main className="exchange-static-page">
      <style>{`
        ...
        .exchange-news-row{grid-template-columns:minmax(0,24%) minmax(0,49.5%) minmax(8px,1%) minmax(0,25.5%);min-height:clamp(300px,19.53125vw,380px);padding:.75vw 1.1vw .65vw}
        ...
        .news-art-crop{min-width:0;overflow:hidden}.news-studio-art,.news-lower-third-art{object-fit:cover;object-position:center}.news-studio-art{image-rendering:auto}.news-lower-third-art{object-position:center}
