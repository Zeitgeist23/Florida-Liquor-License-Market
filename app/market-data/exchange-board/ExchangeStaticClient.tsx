  ...
  return (
    <main className="exchange-static-page">
      <style>{`
        ...
        .exchange-live-footer{position:relative;width:100%;aspect-ratio:1024/68;min-height:92px;overflow:hidden;background:#020f20;color:#e9eef2;font-size:clamp(8px,.72vw,14px)}.exchange-live-footer::before{content:'';position:absolute;z-index:1;inset:0;background:rgb(3 21 38/.91)}
        ...
        .exchange-footer-brand{position:absolute;z-index:2;left:1.55%;top:8%;display:flex;align-items:center;width:11.4%;height:84%;background:linear-gradient(90deg,#010f20 0%,#031526 100%)}.exchange-footer-brand img{display:block;width:100%;height:100%;object-fit:contain}
