  ...
  return (
    <main className="exchange-static-page">
      <style>{`
        ...
        .news-network-mark{left:34%;width:32%;height:24%;background:transparent;isolation:isolate}.news-network-mark::before{content:'';position:absolute;z-index:-1;inset:-12% -10% -48%;background:radial-gradient(ellipse at 50% 40%,#08284e 0%,rgba(4,24,42,.98) 58%,rgba(4,24,42,.88) 76%,transparent 100%)}.news-network-mark img{filter:grayscale(1) sepia(1) saturate(7) hue-rotate(355deg) brightness(1.35) drop-shadow(0 0 4px rgba(255,189,34,.75))}.news-network-copy strong{color:#f7d88b;font-size:clamp(21px,2.15vw,41px);text-shadow:0 0 5px rgba(255,183,28,.65)}
