  ...
  return (
    <main className="exchange-static-page">
      <style>{`
        ...
        .news-copy-panel .outline-button{width:80%;min-height:clamp(31px,2.75vw,52px)}.news-lower-third{left:-4.75vw;height:20%}
