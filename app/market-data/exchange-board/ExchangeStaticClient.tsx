...
export default function ExchangeStaticClient({ marketSnapshot, tickerListings }: ExchangeStaticClientProps) {
  ...
  const toolCards = [
    { title: "List Your License", description: "Reach qualified buyers on Florida's largest marketplace.", action: "LIST YOUR LICENSE →", href: "/sell-your-license", artLeft: "-2.4%", artTop: "-66.15%" },
    { title: "Seller Self-Directed Listing", description: "List your license directly. Full control. More exposure.", action: "GET STARTED →", href: "/sell-your-license", artLeft: "-17.93%", artTop: "-66.15%" },
    { title: "Market Data", description: "Live market data, historical trends, and pricing insights.", action: "VIEW MARKET DATA →", href: "/market-data", artLeft: "-33.45%", artTop: "-66.15%" },
    { title: "County Heat Maps", description: "Explore license availability and market activity by county.", action: "VIEW COUNTY MAPS →", href: "/counties", artLeft: "-49.08%", artTop: "-66.15%" },
    { title: "Appraisals & Valuation", description: "Get a professional liquor license valuation.", action: "GET A VALUATION →", href: "/florida-liquor-license-appraisal", artLeft: "-64.8%", artTop: "-66.15%" },
    { title: "License Types", description: "Learn about 4COP, 3PS and more.", action: "BROWSE LICENSE TYPES →", href: "/resources/florida-liquor-license-types", artLeft: "-80.43%", artTop: "-66.15%" },
    { title: "Financing a License", description: "Explore financing options and connect with lenders.", action: "VIEW FINANCING →", href: "/financing", artLeft: "-2.4%", artTop: "-75.05%" },
    { title: "FLLM News", description: "Market trends, analysis, and industry updates.", action: "VIEW NEWS →", href: "/florida-liquor-license-news", artLeft: "-17.93%", artTop: "-75.05%" },
    { title: "Featured Broker Listings", description: "Hand-selected broker opportunities.", action: "VIEW BROKER LISTINGS →", href: "/listings", artLeft: "-33.45%", artTop: "-75.05%" },
    { title: "Attorney Directory", description: "Find experienced Florida liquor license attorneys.", action: "FIND AN ATTORNEY →", href: "/resources/liquor-license-attorneys", artLeft: "-49.08%", artTop: "-75.05%" },
    { title: "Resources & Guides", description: "Regulations, transfer process, FAQs and educational content.", action: "VIEW RESOURCES →", href: "/resources", artLeft: "-64.8%", artTop: "-75.05%" },
    { title: "Investment Opportunities", description: "Explore high-growth markets and investment insights.", action: "VIEW OPPORTUNITIES →", href: "/invest", artLeft: "-80.43%", artTop: "-75.05%" },
  ];
