  ...
  return (
    <main className="exchange-static-page">
      <style>{`
        ...
        .exchange-news-row{grid-template-columns:minmax(0,22.645%) minmax(0,54.108%) minmax(8px,.501%) minmax(0,22.746%);min-height:clamp(300px,19.53125vw,380px);padding:.75vw 1.1vw .65vw}
        .news-copy-panel{min-width:0;padding:clamp(14px,1vw,20px)}.news-copy-panel h2{max-width:100%;font-size:clamp(18px,1.25vw,25px);line-height:1.12;white-space:normal}.news-copy-panel p{margin:1.15vw 0 1.65vw;font-size:clamp(13px,.86vw,17px);line-height:1.5}.news-copy-panel .outline-button{box-sizing:border-box;width:min(100%,320px);padding:0 .75vw;white-space:nowrap}
        .news-art-crop{min-width:0;overflow:visible}.news-studio-art,.news-lower-third-art{object-fit:cover;object-position:center}.news-studio-art{image-rendering:auto}.news-lower-third-art{object-position:center}
        ...
        @media(max-width:820px){.exchange-news-row{grid-template-columns:minmax(0,1fr);padding:8px}.news-copy-panel,.news-art-crop,.news-headlines{grid-column:1;min-height:220px}.news-copy-panel{padding:20px}.news-copy-panel p{margin:18px 0 24px}.news-art-crop .news-studio-art{left:0;top:0;width:100%;height:79.4737%}.news-art-crop .news-lower-third-art{left:-8.1482%;top:auto;width:108.1482%;height:20.5263%}.news-headlines{padding:16px}.news-headlines header{margin-bottom:8px}.news-headlines>a{grid-template-columns:24px minmax(0,1fr);gap:14px;padding:10px 6px;font-size:14px}.featured-html{padding:8px}.featured-heading{height:38px}.featured-heading h2{font-size:18px}.featured-heading a{font-size:11px}}
      `}</style>
