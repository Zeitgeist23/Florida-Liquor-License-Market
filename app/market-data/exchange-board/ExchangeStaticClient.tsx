  ...
  return (
    <main className="exchange-static-page">
      <style>{`
        ...
        .exchange-news-row{display:grid;grid-template-columns:23% 53.5% 23.5%;height:19vw;min-height:200px;padding:.3vw .75vw;background:#031421;border-bottom:2px solid #b88612}.news-copy-panel,.news-headlines{border:1px solid #17678d;background:#04182a}.news-copy-panel{margin-left:.55vw;margin-right:.25vw;padding:.8vw;background:radial-gradient(ellipse at 92% 84%,rgba(22,130,219,.3),transparent 33%),linear-gradient(180deg,#04182a 0%,#05213d 67%,#0a4f8d 71%,#063765 75%,#0b5a9c 79%,#06345f 84%,#04182a 100%)}.news-copy-panel h2{margin:0;color:#ffbd22;font-size:clamp(15px,1.55vw,29px);white-space:nowrap}.news-copy-panel p{margin:1.1vw 0 1.9vw;color:#e5edf1;font-size:clamp(9px,.9vw,18px);line-height:1.45}.news-copy-panel .outline-button{width:77%;padding:0;min-height:clamp(30px,2.55vw,48px)}.news-art-crop{position:relative;overflow:visible;margin-right:.55vw;border-block:1px solid #17678d}.news-image-clip{position:absolute;inset:0 0 20%;overflow:hidden}.news-image-clip>img{position:absolute;left:-23.34vw;top:-60.35vw;width:100vw;max-width:none;height:auto}.news-network-mark{position:absolute;z-index:2;left:36%;top:3.5%;display:flex;align-items:center;justify-content:center;gap:.65vw;width:28%;height:21%;background:transparent}.news-network-mark img{width:18%;height:82%;object-fit:contain;filter:grayscale(1) sepia(1) saturate(7) hue-rotate(355deg) brightness(1.55) drop-shadow(0 0 5px #ffbd22)}.news-network-copy{display:grid;text-align:center;line-height:1}.news-network-copy strong{color:#ffe19a;font:700 clamp(22px,2.35vw,45px)/.85 Georgia,'Times New Roman',serif;letter-spacing:.08em;text-shadow:0 0 8px #ffb71c}.news-network-copy small{margin-top:.25vw;color:#fff;font-size:clamp(8px,.72vw,14px);font-weight:950;letter-spacing:.04em}.news-lower-third{position:absolute;z-index:3;left:-4.37vw;right:0;bottom:1%;display:grid;grid-template-columns:12.5% 1fr 25%;align-items:stretch;height:20%;border-top:2px solid #37c9ff;border-bottom:2px solid #074985;background:#07316a;box-shadow:0 -4px 14px rgb(13 133 255/.45)}.news-lower-label{display:grid;place-items:center;padding:0 .3vw;background:#073f8d;color:#ffbd22;text-align:center;font-size:clamp(7px,.72vw,14px);font-weight:950;line-height:1.05}.news-lower-copy{display:grid;align-content:center;padding:0 .8vw;background:linear-gradient(112deg,#f8fbff 0%,#e9f8ff 62%,#24adff 100%);color:#06214a}.news-lower-copy strong{font-size:clamp(10px,1.12vw,21px);line-height:1.05}.news-lower-copy small{margin-top:.18vw;font-size:clamp(6px,.57vw,11px);font-weight:800}.news-lower-right{display:grid;place-content:center;padding:0 .6vw;background:linear-gradient(110deg,#178ee2,#07498f);color:#fff;text-align:center;font-size:clamp(7px,.72vw,14px);font-weight:950;line-height:1.2}.news-headlines{margin-left:.45vw;margin-right:.55vw;padding:.7vw}.news-headlines header{display:flex;justify-content:space-between;gap:.5vw;margin-bottom:.55vw}.news-headlines b{font-size:clamp(9px,.75vw,14px)}.news-headlines header a{color:#28d7ff;font-size:clamp(8px,.65vw,12px);font-weight:900;text-decoration:none}.news-headlines>a{display:grid;grid-template-columns:1.7vw 1fr;gap:2.45vw;padding:.42vw 0 .42vw 2.45vw;border-bottom:1px solid rgba(255,255,255,.08);color:#e8f0f4;text-decoration:none;font-size:clamp(8px,.69vw,13px);line-height:1.25}.news-headlines>a::before{content:'▤';color:#fff;font-size:clamp(17px,1.75vw,34px)}
        ...
        .news-copy-panel{background:radial-gradient(ellipse at 90% 100%,rgba(20,114,196,.42),transparent 54%),linear-gradient(180deg,#04182a 0%,#05203b 54%,#07325c 62%,#094b82 70%,#06345f 82%,#04182a 100%)}
        ...
        .news-copy-panel .outline-button{width:79%;min-height:clamp(31px,2.75vw,52px)}.news-lower-third{left:-4.37vw;height:20%}
