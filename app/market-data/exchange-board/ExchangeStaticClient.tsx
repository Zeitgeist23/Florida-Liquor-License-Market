  ...
  return (
    <main className="exchange-static-page">
      <style>{`
        ...
        .news-headlines{display:flex;flex-direction:column}.news-headlines header{flex:0 0 auto}.news-headlines>a{flex:1;font-size:clamp(9px,.78vw,15px);line-height:1.3}
