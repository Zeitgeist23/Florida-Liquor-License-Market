  ...
  return (
    <main className="exchange-static-page">
      <style>{`
        ...
        @media(min-width:821px){.exchange-bid-side{grid-template-rows:5.45vw minmax(0,1fr)}.exchange-bid-heading p{font-size:clamp(11px,.82vw,16px);line-height:1.45}.exchange-bid-form{gap:.62vw 1.15vw}.exchange-bid-form h3{font-size:clamp(13px,.98vw,19px)}.exchange-bid-form label{gap:.25vw;font-size:clamp(10px,.75vw,14px);line-height:1.25}.exchange-bid-form input[type=text],.exchange-bid-form input[type=email],.exchange-bid-form input[type=tel]{height:2.05vw;min-height:30px;font-size:clamp(11px,.72vw,14px)}.exchange-bid-check{align-items:flex-start;gap:.55vw!important;margin:.32vw 0;font-size:clamp(9px,.65vw,12px)!important;line-height:1.4;white-space:normal}.exchange-bid-check input{flex:0 0 auto;width:1.25vw;height:1.25vw;min-width:17px;min-height:17px;margin-top:.05vw}.exchange-explainer>p:not(.exchange-confidence){margin-top:1vw;font-size:clamp(11px,.85vw,16px);line-height:1.5}.exchange-explainer ul{top:1.45vw;gap:.85vw}.exchange-explainer li{font-size:clamp(11px,.82vw,16px);line-height:1.4}.exchange-explainer li::before{width:1.55vw;height:1.55vw;font-size:clamp(11px,.78vw,15px)}.exchange-confidence{font-size:clamp(10px,.82vw,16px);line-height:1.35}}
