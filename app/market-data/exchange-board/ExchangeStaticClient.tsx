  ...
  return (
    <main className="exchange-static-page">
      <style>{`
        ...
        .license-asset-art{isolation:isolate;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:clamp(10px,.85vw,16px);background:radial-gradient(circle at 50% 42%,rgba(20,122,173,.34),transparent 48%),linear-gradient(145deg,#0a2e4a,#031523 72%);color:#eef7fb;text-align:center}.license-asset-art::before{content:'';position:absolute;z-index:-1;inset:clamp(7px,.48vw,10px);border:1px solid rgba(246,181,31,.78);border-radius:3px;box-shadow:inset 0 0 18px rgba(40,196,255,.12)}.license-asset-art::after{content:'FL';position:absolute;z-index:-2;color:rgba(35,199,255,.1);font:900 clamp(58px,5.2vw,100px)/1 Georgia,serif;letter-spacing:-.12em;transform:translateX(-.05em)}.license-asset-art.is-3ps{background:radial-gradient(circle at 50% 42%,rgba(19,151,170,.32),transparent 48%),linear-gradient(145deg,#083143,#031523 72%)}.license-document-kicker{position:relative;z-index:1;margin-bottom:.55vw;color:#ffbd22;font-size:clamp(7px,.52vw,10px);font-weight:900;letter-spacing:.12em}.license-asset-art b{position:relative;z-index:1;font:800 clamp(8px,.61vw,12px)/1.25 Georgia,serif;letter-spacing:.04em}.license-asset-art strong{position:relative;z-index:1;margin:.7vw 0 .55vw;color:#28d7ff;font-size:clamp(28px,2.45vw,47px);line-height:1;text-shadow:0 0 14px rgba(40,215,255,.25)}.license-asset-art small{position:relative;z-index:1;color:#dbe8ee;font-size:clamp(6px,.45vw,9px);font-weight:800;letter-spacing:.08em;line-height:1.25}
