  ...
  return (
    <main className="market-heat-map-page fllm-official-page">
      ...
      <section className="market-heat-map-note">
        <div className="market-heat-map-shell">Marketplace asking prices are current disclosed asks, not appraisals or verified closed-sale values. Inventory can change as listings are added, sold, withdrawn or repriced.</div>
      </section>

      <footer className="market-heat-map-footer" aria-label="Florida Liquor License Market footer">
        <div className="market-heat-map-shell market-heat-map-footer-main">
          <div className="market-heat-map-footer-brand">
            <Link href="/" aria-label="Florida Liquor License Market home"><Image src="/assets/brand-sharp.svg" alt="Florida Liquor License Market" width={130} height={53} /></Link>
        ...
        <div className="market-heat-map-footer-national"><span>Looking for a liquor license outside Florida?</span><a href="https://www.liquorlicensemarket.com/">Visit Liquor License Market — The National Marketplace.</a></div>
      </footer>
    </main>
  );
}
