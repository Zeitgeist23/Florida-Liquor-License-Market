  ...
  return (
    <main style={{ minHeight: "100vh", color: "#eef3f7", background: "#07131e" }}>
      <style>{`
        ...
        .series-change-item h3{margin:0 0 9px;color:#f6a700!important;font-size:20px;line-height:1.25}
        .license-system-route main section .series-change-item h3{color:#f6a700!important;text-shadow:none!important}
