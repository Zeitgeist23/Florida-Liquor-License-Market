  ...
  return (
    <main style={{ minHeight: "100vh", color: "#eef3f7", background: "#07131e" }}>
      <style>{`
        ...
        .active-operation-note{border-color:rgba(246,167,0,.68)!important;border-left:5px solid #f6a700!important;background:radial-gradient(circle at 14% 0%,rgba(112,220,255,.16),transparent 42%),linear-gradient(145deg,#1a4a67 0%,#133b56 52%,#0b2a42 100%)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.14),inset 0 -10px 22px rgba(0,0,0,.17),0 4px 0 rgba(132,91,11,.68),0 20px 38px rgba(0,0,0,.29),0 0 20px rgba(112,220,255,.08)!important}
        ...
        .active-operation-note:hover,.active-operation-note:focus-within{transform:translateY(-5px) scale(1.008);border-color:#ffc13b!important;background:radial-gradient(circle at 14% 0%,rgba(112,220,255,.27),transparent 44%),linear-gradient(145deg,#215a79 0%,#18465f 52%,#10334c 100%)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.18),inset 0 0 34px rgba(112,220,255,.09),0 5px 0 rgba(160,109,10,.76),0 26px 48px rgba(0,0,0,.35),0 0 28px rgba(112,220,255,.23),0 0 18px rgba(246,167,0,.15)!important;filter:brightness(1.06)}
