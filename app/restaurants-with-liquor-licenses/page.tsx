      ...
      <section className="fllm-template-hero">
        <div className="fllm-template-shell">
          ...
          <div className="fllm-ui-actions">
            <FllmButton href="#restaurant-inventory">View Restaurant Listings</FllmButton>
        ...
        <div className="fllm-template-shell">
          ...
          <FllmCardGrid columns={3}>
            <FllmCard eyebrow="Transferable full-liquor asset" title="Restaurants With 4COP Quota Licenses" variant="gold">
              ...
              <div className="fllm-ui-actions">
                <FllmButton href="/listings?type=businesses">Browse Quota Business Listings</FllmButton>
            ...
            <FllmCard eyebrow="Qualification-based full liquor" title="Restaurants With 4COP SFS / SRX Licenses" variant="gold">
              ...
              <div className="fllm-ui-actions">
                <FllmButton href="/listings?type=businesses-sfs">Browse SFS / SRX Listings</FllmButton>
            ...
            <FllmCard eyebrow="Beer & wine" title="Restaurants With 2COP Licenses" variant="gold">
              ...
              <div className="fllm-ui-actions">
                <FllmButton href="/listings?type=businesses-2cop">Browse 2COP Listings</FllmButton>
      ...
      <section className="fllm-ui-final-cta">
        <div className="fllm-template-shell">
          ...
          <div className="fllm-ui-final-actions">
            <FllmButton href="/brokers/list-your-license">List a Restaurant Opportunity</FllmButton>
