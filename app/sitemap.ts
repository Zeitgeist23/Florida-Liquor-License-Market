...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const corePages: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/self-directed-ira-liquor-license-lending`, lastModified, changeFrequency: "monthly", priority: 0.82 },
    ...
    { url: `${siteUrl}/license-types/4cop-quota`, lastModified, changeFrequency: "monthly", priority: 0.88 },
    { url: `${siteUrl}/license-types/3ps-package-store`, lastModified, changeFrequency: "monthly", priority: 0.86 },
    { url: `${siteUrl}/license-types/2cop-beer-wine`, lastModified, changeFrequency: "monthly", priority: 0.82 },
    { url: `${siteUrl}/license-types/4cop-sfs-restaurant`, lastModified, changeFrequency: "monthly", priority: 0.84 },
    ...
    { url: `${siteUrl}/florida-liquor-license-appraisal`, lastModified, changeFrequency: "daily", priority: 0.92 },
    { url: `${siteUrl}/florida-liquor-license-news`, lastModified, changeFrequency: "daily", priority: 0.85 },
    { url: `${siteUrl}/florida-liquor-license-news/park-street-trust-florida-quota-license-court-findings`, lastModified, changeFrequency: "monthly", priority: 0.78 },
    { url: `${siteUrl}/florida-liquor-license-lottery`, lastModified, changeFrequency: "daily", priority: 0.9 },
    ...
    { url: `${siteUrl}/resources/liquor-license-attorneys`, lastModified, changeFrequency: "monthly", priority: 0.78 },
    { url: `${siteUrl}/resources/florida-liquor-license-property-or-privilege`, lastModified, changeFrequency: "monthly", priority: 0.76 },
