  ...
  return (
    <main className="transaction-services-page">
      ...
      <style>{`
        ...
        .transaction-services{padding:34px 0 72px}.transaction-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:22px}.transaction-card{scroll-margin-top:90px;padding:28px;border:1px solid rgba(255,255,255,.11);border-radius:12px;background:linear-gradient(145deg,#0a2237,#061726);box-shadow:0 14px 34px rgba(0,0,0,.22)}.transaction-card:hover{border-color:rgba(241,169,26,.55)}.transaction-card h2{margin:7px 0 6px;font-size:28px}.transaction-audience{margin:0 0 14px!important;color:#f1aa1c!important;font-weight:800}.transaction-card p{color:#c8d4dc;line-height:1.7}.transaction-card ul{display:grid;gap:8px;margin:18px 0 22px;padding-left:20px;color:#d7e0e6}.transaction-link-row{display:flex;flex-wrap:wrap;gap:9px}.transaction-link-row a{display:inline-flex;align-items:center;min-height:40px;padding:0 13px;border:1px solid rgba(241,169,26,.48);border-radius:5px;color:#f4b22a;background:#071827;text-decoration:none;font-size:12px;font-weight:900}.transaction-link-row a:first-child{color:#071521;background:linear-gradient(145deg,#ffc441,#e99b06);border-color:#f1aa1c}.transaction-link-row a:hover{text-decoration:underline;text-underline-offset:3px}
