...
const SIGNATURE = "fllm-resources-v1";
...
function installStyles() {
  ...
  style.textContent = `
    ...
    .resources-header-menu>a[data-global-transaction="true"]{
    ...
    .native-nav-resources-menu>a[data-global-transaction="true"]:hover .global-transaction-cta,
    .resources-header-menu>a[data-global-transaction="true"]:hover .global-transaction-copy,
    .resources-header-menu>a[data-global-transaction="true"]:hover .global-transaction-cta{color:#f6a700}
    @media(max-width:980px){
      .native-nav-resources-menu,.resources-header-menu{grid-template-columns:repeat(2,minmax(0,1fr))!important}
    }
    @media(max-width:760px){
      .native-nav-resources-menu,.resources-header-menu{grid-template-columns:1fr!important;width:min(360px,calc(100vw - 24px))!important;max-height:70vh;overflow:auto}
      .native-nav-resources-menu>a[data-global-transaction="true"],.resources-header-menu>a[data-global-transaction="true"]{display:block!important;grid-column:auto!important}
...
function syncAll() {
  installStyles();
  document.querySelectorAll(".native-nav-resources-menu,.resources-header-menu").forEach(syncMenu);
}
