  ...
  return (
    <main className="market-page">
      ...
      <section className="market-content" id="featured"><div className="page-shell">
        ...
        <aside className="national-markets-prompt" aria-label="National liquor license markets"><span><strong>Looking for a liquor license outside Florida?</strong><small>Explore active markets across the United States on Liquor License Market.</small></span><a href="https://www.liquorlicensemarket.com/">Explore National Markets <span aria-hidden="true">›</span></a></aside>\n        <section className="cta" id="sell"><img className="cta-icon" src="/assets/cta-shield.png" alt="" aria-hidden="true" /><span><strong>Ready to Buy, Sell, Finance, or Invest in a Liquor License?</strong><small>Join Florida&apos;s most trusted marketplace for liquor license transactions.</small></span><a className="btn btn-gold" href="mailto:info@floridaliquorlicensemarket.com?subject=Florida%20liquor%20license%20inquiry">Get Started Today ›</a></section>
      </div></section>
      <footer id="resources"><div className="page-shell footer-grid"><div className="footer-brand"><img src="/assets/brand-footer.svg" alt="Florida Liquor License Market" /><p>Florida&apos;s marketplace for buying, selling &amp; financing liquor licenses.</p><b>Buy · Sell · Finance · Invest</b></div><div><strong>Marketplace</strong><a href="#featured">Browse Licenses</a><a href="#sell">Sell Your License</a><a href="#financing">Financing Solutions</a><a href="#market-data">Investment Opportunities</a></div><div><strong>Company</strong><a href="#top">About Us</a><a href="#top">Our Process</a><a href="#top">Testimonials</a><a href="https://www.liquorlicensemarket.com/">National Liquor License Markets</a><a href="mailto:info@floridaliquorlicensemarket.com">Contact Us</a></div><div><strong>Resources</strong><a href="#market-data">Market Data</a><a href="#market-data">Blog</a><a href="#resources">FAQ</a><a href="#resources">Documents</a></div><div className="social"><strong>Stay Connected</strong><div><a href="#resources" aria-label="LinkedIn">in</a><a href="#resources" aria-label="Facebook">f</a><a href="#resources" aria-label="Instagram">◎</a><a href="#resources" aria-label="YouTube">▶</a><a href="mailto:info@floridaliquorlicensemarket.com" aria-label="Email">✉</a></div><small><a href="/privacy-policy">Privacy Policy</a> &nbsp;|&nbsp; <a href="/terms-of-use">Terms of Use</a>.</small></div></div><div className="page-shell copyright">© 2026 Florida Liquor License Market. All rights reserved.</div></footer>
