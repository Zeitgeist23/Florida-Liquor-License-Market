...
const listings: Listing[] = [
  ...
  { county: "Hillsborough County", type: "4COP Quota", price: 245000, priceLabel: "$245,000", image: "/assets/listing-miami.png", sourceName: "BizBuySell", sourceUrl: "https://www.bizbuysell.com/business-asset/hillsborough-county-4cop-quota-liquor-license-for-sale/2479770/" },
  { county: "Lake County", type: "4COP Quota", price: 275000, priceLabel: "$275,000", image: "/assets/listing-palm-beach.png", sourceName: "BizBuySell", sourceUrl: "https://www.bizbuysell.com/business-asset/4cop-quota-liquor-license-lake-county-florida/2463053/" },
  { county: "Pasco County", type: "4COP Quota", price: 325000, priceLabel: "$325,000", image: "/assets/listing-sarasota.png", sourceName: "BusinessesForSale", sourceUrl: "https://us.businessesforsale.com/us/pasco-county-4cop-quota-liquor-license.aspx" },
  { county: "Escambia County", type: "4COP Quota", price: 575000, priceLabel: "$575,000", image: "/assets/listing-lee.png", sourceName: "BizBuySell", sourceUrl: "https://www.bizbuysell.com/business-asset/4cop-quota-liquor-license/2480306/" },
  { county: "St. Lucie County", type: "4COP Quota", price: 275000, priceLabel: "$275,000", image: "/assets/listing-miami.png", sourceName: "BizBuySell", sourceUrl: "https://www.bizbuysell.com/business-asset/st-lucie-county-4cop-3ps-quota-liquor-license-for-sale/2464222/" },
];
  ...
  return (
    <main className="market-page">
      <section className="hero" id="top">
        ...
        <header className="site-header page-shell">
          ...
          <nav className={menuOpen ? "primary-nav is-open" : "primary-nav"} aria-label="Primary navigation">
            <a href="#featured"><span>Buy</span><img className="nav-chevron" src="/assets/nav-chevron.png" alt="" aria-hidden="true" /></a><a href="#sell"><span>Sell</span><img className="nav-chevron" src="/assets/nav-chevron.png" alt="" aria-hidden="true" /></a><a href="#financing"><span>Finance</span><img className="nav-chevron" src="/assets/nav-chevron.png" alt="" aria-hidden="true" /></a><a href="#market-data"><span>Invest</span><img className="nav-chevron" src="/assets/nav-chevron.png" alt="" aria-hidden="true" /></a><a href="#market-data"><span>Market Data</span><img className="nav-chevron" src="/assets/nav-chevron.png" alt="" aria-hidden="true" /></a><a href="#resources"><span>Resources</span><img className="nav-chevron" src="/assets/nav-chevron.png" alt="" aria-hidden="true" /></a>
          </nav>
        ...
        <div className="hero-content page-shell">
          ...
          <div className="audience-row" aria-label="Marketplace audiences"><span><img src="/assets/audience-buyers.png" alt="" aria-hidden="true" /><b>Buyers</b></span><span><img src="/assets/audience-sellers.png" alt="" aria-hidden="true" /><b>Sellers</b></span><span><img src="/assets/audience-investors.png" alt="" aria-hidden="true" /><b>Investors</b></span><span><img src="/assets/audience-financing.png" alt="" aria-hidden="true" /><b>Financing Solutions</b></span><span><img src="/assets/audience-florida.png" alt="" aria-hidden="true" /><b>Across Florida</b></span></div>
          ...
          <form className="license-search" onSubmit={submitSearch}>
            ...
            <div className="search-assurances"><span><img src="/assets/assurance-confidential.png" alt="" aria-hidden="true" />Confidential Listings</span><span><img src="/assets/assurance-professional.png" alt="" aria-hidden="true" />Professional Representation</span><span><img src="/assets/assurance-statewide.png" alt="" aria-hidden="true" />Statewide Coverage</span><span><img src="/assets/assurance-secure.png" alt="" aria-hidden="true" />Discreet. Secure. Trusted.</span></div>
          </form>
        </div>
      </section>
      ...
      <section className="market-content" id="featured"><div className="page-shell">
        ...
        <section className="market-report" id="market-report" aria-labelledby="market-report-title"><div className="report-copy"><span className="report-eyebrow">Video Briefing · Episode 1</span><h2 id="market-report-title">Florida Liquor License<br /><em>Market Report</em></h2><p>Watch our three-minute introduction to learn how buyers, sellers, financing partners, and investors connect through Florida&apos;s dedicated liquor license marketplace.</p><a className="report-episodes-link" href="#resources">View All Episodes <span aria-hidden="true">›</span></a></div><div className="report-video" role="img" aria-label="Video coming soon: Florida Liquor License Market Report"><div className="report-screen"><span className="report-live-label">Market Report</span><div className="report-desk" aria-hidden="true"><span className="report-presenter presenter-one" /><span className="report-presenter presenter-two" /><i /></div><div className="report-video-message"><span className="report-play" aria-hidden="true">▶</span><strong>Episode 1 Coming Soon</strong><small>The video will play here—never automatically.</small></div></div></div></section>
        <section className="insight-grid" id="market-data">
          ...
          <article className="info-panel map-panel"><div className="panel-title"><h2>Florida Market Insights</h2><a href="#market-data">View All ›</a></div><div className="map-content"><div><h3>Average 4COP<br />Quota Price<br />by County</h3><ul><li><i className="range-1" />$600K+</li><li><i className="range-2" />$450K – $600K</li><li><i className="range-3" />$300K – $450K</li><li><i className="range-4" />$200K – $300K</li><li><i className="range-5" />Under $200K</li></ul></div><div className="florida-map-art"><img src="/assets/florida-map-clean.png" alt="Florida average 4COP quota price map by county" /></div></div><a className="panel-link" href="#market-data">Explore Market Data ›</a></article>
