...
export default function Home({ marketListings }: { marketListings: MarketplaceListing[] }) {
  ...
  return (
    <main className="market-page">
      ...
      <footer id="resources"><div className="page-shell footer-grid"><div className="footer-brand"><img src="/assets/brand-footer.svg" alt="Florida Liquor License Market" /><p>Florida&apos;s marketplace for buying, selling &amp; financing liquor licenses.</p><b>Buy · Sell · Finance · Invest</b></div><div><strong>Marketplace</strong><a href="#featured">Browse Licenses</a><a href="#sell">Sell Your License</a><a href="#financing">Financing Solutions</a><a href="#market-data">Investment Opportunities</a></div><div><strong>Company</strong><a href="#top">About Us</a><a href="#top">Our Process</a><a href="#top">Testimonials</a><a href="mailto:info@floridaliquorlicensemarket.com">Contact Us</a></div><div><strong>Resources</strong><a href="/free-guide">Free Buyer&apos;s &amp; Seller&apos;s Guide</a><a href="/resources">Resource Center</a><a href="/resources/forms">ABT Forms</a><a href="/resources/florida-liquor-license-laws">License Laws</a></div><div className="social"><strong>Stay Connected</strong><div><a href="#resources" aria-label="LinkedIn">in</a><a href="#resources" aria-label="Facebook">f</a><a href="#resources" aria-label="Instagram">◎</a><a href="#resources" aria-label="YouTube">▶</a><a href="mailto:info@floridaliquorlicensemarket.com" aria-label="Email">✉</a></div><small><a href="/privacy-policy">Privacy Policy</a> &nbsp;|&nbsp; <a href="/terms-of-use">Terms of Use</a>.</small></div></div><div className="page-shell copyright">© 2026 Florida Liquor License Market. All rights reserved.</div></footer>
