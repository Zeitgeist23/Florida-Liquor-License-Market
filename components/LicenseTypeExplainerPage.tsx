    ...
    <main className="license-explainer-page">
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .lt-card h2{margin:0 0 18px;color:var(--gold);font-size:20px;font-weight:800;line-height:1.18;letter-spacing:.01em}.lt-card ul{margin:0;padding-left:22px;color:#f4f7fa;font-size:15.5px;line-height:1.68}.lt-card li{color:#f4f7fa;margin-bottom:12px}.lt-card li::marker{color:var(--gold)}.lt-card li+li{margin-top:0}.lt-card-businesses ul{display:grid;grid-template-columns:1fr 1fr;column-gap:24px;row-gap:0;align-content:start}.lt-card-businesses li{break-inside:avoid;margin-top:0!important;margin-bottom:12px}
