    ...
    <main className="license-explainer-page">
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .lt-official{padding:0 0 34px}.lt-official-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-top:16px}.lt-official-grid a{display:flex;flex-direction:column;min-height:142px;padding:19px;border:1px solid rgba(255,255,255,.14);border-top:3px solid var(--gold);border-radius:10px;background:#123751;color:inherit;text-decoration:none;transition:transform .18s ease,border-color .18s ease}.lt-official-grid a:hover,.lt-official-grid a:focus-visible{transform:translateY(-2px);border-color:var(--gold);outline:none}.lt-official-grid strong{color:#fff;font-size:16px;line-height:1.35}.lt-official-grid p{margin:8px 0 12px;color:var(--muted);font-size:13px;line-height:1.55}.lt-official-grid small{margin-top:auto;color:var(--gold);font-weight:900;text-transform:uppercase}
