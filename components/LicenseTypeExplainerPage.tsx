...
import ScrollActiveComparisonTable from "./ScrollActiveComparisonTable";
    ...
    <main className={`license-explainer-page${props.organizedSummary ? " lt-readable-layout" : ""}`}>
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .lt-hero h1{margin:0;color:#fff;font:700 clamp(34px,5vw,60px)/1.02 Georgia,serif;max-width:930px}.lt-license-token{display:inline-block;white-space:nowrap;color:inherit!important;font-size:inherit!important;font-weight:inherit!important;letter-spacing:inherit!important;line-height:inherit!important;text-transform:none!important}.lt-straight-numeral{display:inline-block;font-family:Arial,Helvetica,sans-serif;font-size:1em!important;font-style:normal;font-weight:700;line-height:1;letter-spacing:normal!important;text-transform:none!important;color:inherit!important;vertical-align:baseline}
        ...
        .lt-series-meaning{display:flex;align-items:center;gap:10px;width:fit-content;max-width:100%;margin:14px 0 0;padding:10px 14px;border-left:3px solid var(--gold);border-radius:7px;background:rgba(4,23,39,.42);box-shadow:inset 0 1px 0 rgba(255,255,255,.04),0 8px 18px rgba(0,0,0,.12);color:#dce7ed;font-size:14px;line-height:1.4}.lt-series-meaning strong{color:var(--gold);font-weight:900}.lt-term-highlight{color:#70dcff;font-weight:400;text-shadow:0 0 12px rgba(112,220,255,.16)}
        .lt-readable-layout .lt-hero{position:relative;isolation:isolate;overflow:hidden;padding-top:38px;padding-bottom:38px}.lt-readable-layout .lt-hero::before{content:"";position:absolute;inset:0 auto 0 50%;z-index:-2;width:100vw;transform:translateX(-50%);background:linear-gradient(90deg,rgba(5,27,46,.98) 0%,rgba(7,35,57,.94) 42%,rgba(7,37,60,.62) 76%,rgba(5,27,46,.76) 100%);box-shadow:inset 0 1px 0 rgba(246,167,0,.52),inset 0 -1px 0 rgba(246,167,0,.38)}.lt-readable-layout .lt-hero-backdrop{position:absolute;inset:0 auto 0 50%;z-index:-3;width:100vw;transform:translateX(-50%);background-position:center 52%;background-size:cover;filter:saturate(.78) contrast(1.08)}.lt-readable-layout .lt-hero-watermark{position:absolute;right:-1vw;bottom:-.18em;z-index:-1;color:#fff;font:900 clamp(90px,14vw,220px)/.8 Arial,Helvetica,sans-serif;letter-spacing:-.055em;opacity:.045;pointer-events:none;white-space:nowrap}.lt-readable-layout .lt-hero h1{text-shadow:0 4px 24px rgba(0,0,0,.45)}.lt-readable-layout .lt-definition{background:linear-gradient(145deg,rgba(4,27,45,.94),rgba(8,42,66,.82));box-shadow:inset 0 1px 0 rgba(255,255,255,.07),0 18px 38px rgba(0,0,0,.22);backdrop-filter:blur(2px)}.lt-readable-layout .lt-plain{text-shadow:0 2px 10px rgba(0,0,0,.5)}
        ...
        .lt-summary-head{text-align:center}
        .lt-summary{padding:24px 0 34px}.lt-summary-head{margin:0 0 16px}.lt-summary-head>span{color:var(--gold);font-size:11px;font-weight:900;letter-spacing:.1em;text-transform:uppercase}.lt-summary-head h2{margin:7px 0 0;color:#fff;font:700 29px/1.15 Georgia,serif}.lt-summary-compare{display:grid;grid-template-columns:1fr 1fr;gap:18px;align-items:stretch}.lt-summary-compare .lt-card{height:100%}.lt-readable-layout .lt-hero h1{max-width:none;font-size:clamp(34px,4.2vw,56px);white-space:nowrap}.lt-readable-layout .lt-plain{font-size:19px;line-height:1.72}.lt-readable-layout .lt-series-meaning{gap:13px;min-height:58px;padding:15px 20px;border-left-width:5px;border-top:1px solid rgba(246,167,0,.28);border-right:1px solid rgba(255,255,255,.08);border-bottom:1px solid rgba(255,255,255,.08);background:#071f34;color:#fff;font-size:18px;line-height:1.5;box-shadow:inset 0 1px 0 rgba(255,255,255,.06),0 10px 22px rgba(0,0,0,.2)}.lt-readable-layout .lt-series-meaning strong{font-size:18px;letter-spacing:.01em}.lt-readable-layout .lt-series-meaning span{color:#fff;font-weight:600}.lt-readable-layout .lt-summary-head>span{font-size:13px}.lt-readable-layout .lt-summary-head h2{font-size:32px}.lt-readable-layout .lt-card h2{font-size:22px}.lt-readable-layout .lt-card ul{font-size:17px;line-height:1.68}.lt-readable-layout .lt-card li{margin-bottom:11px}.lt-readable-layout .lt-requirements{padding:38px 0 48px}.lt-readable-layout .lt-requirements-head{display:block;margin-bottom:32px;text-align:center}.lt-readable-layout .lt-requirements-head>div>span{display:block;font-size:13px}.lt-readable-layout .lt-requirements-head h2{max-width:none;margin:11px 0 18px;color:#70dcff}.lt-readable-layout .lt-requirements-head p{max-width:1120px;margin:0 auto;font-size:18px;line-height:1.75}.lt-readable-layout .lt-requirement-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.lt-readable-layout .lt-requirement-card{display:flex;min-height:235px;flex-direction:column;padding:26px 28px}.lt-readable-layout .lt-requirement-card span{font-size:14px}.lt-readable-layout .lt-requirement-card strong{font-size:25px}.lt-readable-layout .lt-requirement-card p{font-size:17px;line-height:1.65}.lt-readable-layout .lt-requirement-source{margin-top:auto;padding-top:16px;font-size:15px!important}.lt-readable-layout .lt-requirement-notes{display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-top:18px}.lt-readable-layout .lt-requirement-note{position:relative;isolation:isolate;overflow:hidden;margin:0;padding:19px 22px;border:1px solid rgba(246,167,0,.42);border-left:5px solid var(--gold);border-radius:9px;background:radial-gradient(circle at 18% 0%,rgba(255,255,255,.075),transparent 38%),linear-gradient(145deg,#184463 0%,#123955 52%,#0c2c45 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.08),inset 0 -7px 16px rgba(0,0,0,.13),0 3px 0 rgba(111,77,13,.5),0 13px 27px rgba(0,0,0,.2);color:#e6eef3;font-size:16px;line-height:1.65;transition:transform .2s ease,border-color .2s ease,background .2s ease,box-shadow .2s ease,filter .2s ease}.lt-readable-layout .lt-requirement-note::after{content:"";position:absolute;left:9%;right:9%;bottom:-8px;height:14px;z-index:-1;border-radius:50%;background:rgba(0,0,0,.34);filter:blur(8px)}.lt-readable-layout .lt-requirement-note:hover{transform:translateY(-4px) scale(1.008);border-color:#ffc13b;background:radial-gradient(circle at 18% 0%,rgba(112,220,255,.16),transparent 40%),linear-gradient(145deg,#1c4e6e 0%,#16435f 52%,#10334c 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.12),inset 0 0 26px rgba(112,220,255,.055),0 4px 0 rgba(154,105,10,.64),0 20px 38px rgba(0,0,0,.29),0 0 16px rgba(112,220,255,.12),0 0 14px rgba(246,167,0,.1);filter:brightness(1.04)}.lt-readable-layout .lt-requirement-note strong{display:block;margin-bottom:5px;color:var(--gold);font-size:17px}.lt-readable-layout .lt-comparison{padding:38px 0 48px}.lt-readable-layout .lt-comparison-head{margin-bottom:26px;text-align:center}.lt-readable-layout .lt-comparison-head h2{margin-top:10px;margin-bottom:14px}.lt-readable-layout .lt-comparison-head p{max-width:1000px;margin-left:auto;margin-right:auto;line-height:1.75}.lt-readable-layout .lt-extra article{position:relative;isolation:isolate;overflow:hidden;border-color:rgba(246,167,0,.42);background:radial-gradient(circle at 20% 0%,rgba(255,255,255,.085),transparent 38%),linear-gradient(145deg,#194765 0%,#123a56 52%,#0c2c45 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.09),inset 0 -8px 18px rgba(0,0,0,.14),0 3px 0 rgba(111,77,13,.5),0 15px 30px rgba(0,0,0,.22);transform:translateY(0);transition:transform .2s ease,border-color .2s ease,background .2s ease,box-shadow .2s ease,filter .2s ease}.lt-readable-layout .lt-extra article::after{content:"";position:absolute;left:9%;right:9%;bottom:-8px;height:14px;z-index:-1;border-radius:50%;background:rgba(0,0,0,.34);filter:blur(8px)}.lt-readable-layout .lt-extra article:hover,.lt-readable-layout .lt-extra article:focus-within{transform:translateY(-5px) scale(1.01);border-color:#ffc13b;background:radial-gradient(circle at 20% 0%,rgba(112,220,255,.2),transparent 42%),linear-gradient(145deg,#205675 0%,#174661 52%,#10334d 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.14),inset 0 0 30px rgba(112,220,255,.07),0 4px 0 rgba(158,108,10,.66),0 22px 42px rgba(0,0,0,.31),0 0 22px rgba(112,220,255,.17),0 0 16px rgba(246,167,0,.13);filter:brightness(1.06)}.lt-readable-layout .lt-extra h2{font-size:23px}.lt-readable-layout .lt-extra p{font-size:17px;line-height:1.75}.lt-readable-layout .lt-extra a{font-size:14.5px;line-height:1.45}.lt-readable-layout .lt-rule-grid strong{font-size:18px;line-height:1.42}.lt-readable-layout .lt-rule-grid p{font-size:16.5px;line-height:1.65}.lt-readable-layout .lt-rule-grid small{font-size:14.5px;line-height:1.4}.lt-readable-layout .lt-rule-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.lt-readable-layout .lt-rule-grid a,.lt-readable-layout .lt-research-grid a{position:relative;isolation:isolate;overflow:hidden;padding:26px;border:1px solid rgba(246,167,0,.5);border-top:3px solid var(--gold);border-radius:11px;background:radial-gradient(circle at 18% 0%,rgba(255,255,255,.075),transparent 38%),linear-gradient(145deg,#173f5e 0%,#10334e 52%,#0a263c 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.08),inset 0 -8px 18px rgba(0,0,0,.15),0 3px 0 rgba(116,79,12,.56),0 15px 30px rgba(0,0,0,.22);transform:translateY(0);transition:transform .2s ease,border-color .2s ease,background .2s ease,box-shadow .2s ease,filter .2s ease}.lt-readable-layout .lt-rule-grid a::after,.lt-readable-layout .lt-research-grid a::after{content:"";position:absolute;left:9%;right:9%;bottom:-8px;height:14px;z-index:-1;border-radius:50%;background:rgba(0,0,0,.34);filter:blur(8px)}.lt-readable-layout .lt-rule-grid a:hover,.lt-readable-layout .lt-rule-grid a:focus-visible,.lt-readable-layout .lt-research-grid a:hover,.lt-readable-layout .lt-research-grid a:focus-visible{transform:translateY(-5px) scale(1.012);border-color:#ffc13b;background:radial-gradient(circle at 18% 0%,rgba(112,220,255,.2),transparent 42%),linear-gradient(145deg,#205675 0%,#174661 52%,#10334d 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.14),inset 0 0 30px rgba(112,220,255,.075),0 4px 0 rgba(158,108,10,.66),0 22px 42px rgba(0,0,0,.31),0 0 22px rgba(112,220,255,.18),0 0 16px rgba(246,167,0,.14);filter:brightness(1.06);outline:none}.lt-readable-layout .lt-research-grid strong{font-size:18px;line-height:1.42}.lt-readable-layout .lt-research-grid p{font-size:16.5px;line-height:1.65}.lt-readable-layout .lt-research-grid small{font-size:14.5px;line-height:1.4}
        .lt-readable-layout .lt-summary{padding:42px 0 54px}.lt-readable-layout .lt-requirements,.lt-readable-layout .lt-comparison{padding:48px 0 58px}.lt-readable-layout .lt-official,.lt-readable-layout .lt-rule-updates,.lt-readable-layout .lt-research{padding:18px 0 50px}
        .lt-readable-layout .lt-summary-head,.lt-readable-layout .lt-requirements-head,.lt-readable-layout .lt-comparison-head{margin-bottom:40px;text-align:center}
        .lt-readable-layout .lt-summary-head>span,.lt-readable-layout .lt-requirements-head>div>span,.lt-readable-layout .lt-comparison-head>span,.lt-readable-layout .lt-official>span,.lt-readable-layout .lt-rule-updates>span,.lt-readable-layout .lt-research>span{display:block;margin-bottom:20px;color:var(--gold);font-size:16px;line-height:1.35;font-weight:900;letter-spacing:.12em;text-align:center;text-transform:uppercase}
        ...
        .lt-requirements-head>div>span,.lt-rule-updates>span,.lt-official>span,.lt-research>span{color:var(--gold);font-size:11px;font-weight:900;letter-spacing:.1em;text-transform:uppercase}
        ...
        .lt-requirement-card>span,.lt-requirement-card>strong,.lt-requirement-note>strong{text-align:center}
      ...
      <section className="lt-shell lt-hero">
        {props.organizedSummary && props.imageSrc ? <div aria-hidden="true" className="lt-hero-backdrop" style={{backgroundImage:`url(${props.imageSrc})`}} /> : null}
        {props.organizedSummary ? <span aria-hidden="true" className="lt-hero-watermark">4COP QUOTA</span> : null}
