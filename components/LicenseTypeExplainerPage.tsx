    ...
    <main className={`license-explainer-page${props.organizedSummary ? " lt-readable-layout" : ""}`}>
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .lt-readable-layout .lt-summary-head>span,.lt-readable-layout .lt-requirements-head>div>span,.lt-readable-layout .lt-comparison-head>span,.lt-readable-layout .lt-official>span,.lt-readable-layout .lt-rule-updates>span,.lt-readable-layout .lt-research>span{display:block;margin-bottom:15px;color:var(--gold);font-size:15px;line-height:1.35;font-weight:900;letter-spacing:.11em;text-transform:uppercase}
        .lt-readable-layout .lt-summary-head h2,.lt-readable-layout .lt-requirements-head h2,.lt-readable-layout .lt-comparison-head h2,.lt-readable-layout .lt-official h2,.lt-readable-layout .lt-rule-updates h2,.lt-readable-layout .lt-research h2{margin:0 0 24px;font-size:clamp(34px,3.5vw,42px);line-height:1.17}
