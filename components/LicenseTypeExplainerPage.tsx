    ...
    <main className={`license-explainer-page${props.organizedSummary ? " lt-readable-layout" : ""}`}>
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .lt-readable-layout .lt-hero{position:relative;isolation:isolate;overflow:hidden;padding-top:38px;padding-bottom:38px}.lt-readable-layout .lt-hero::before{content:"";position:absolute;inset:0 auto 0 50%;z-index:-2;width:100vw;transform:translateX(-50%);background:radial-gradient(circle at 78% 22%,rgba(89,190,230,.14),transparent 34%),linear-gradient(135deg,#061d31 0%,#0b3b59 58%,#082a45 100%);box-shadow:inset 0 1px 0 rgba(246,167,0,.52),inset 0 -1px 0 rgba(246,167,0,.38)}.lt-readable-layout .lt-hero-watermark{position:absolute;right:-1vw;bottom:-.18em;z-index:-1;color:#fff;font:900 clamp(90px,14vw,220px)/.8 Arial,Helvetica,sans-serif;letter-spacing:-.055em;opacity:.045;pointer-events:none;white-space:nowrap}.lt-readable-layout .lt-hero h1{text-shadow:0 4px 24px rgba(0,0,0,.45)}.lt-readable-layout .lt-definition{background:linear-gradient(145deg,rgba(4,27,45,.94),rgba(8,42,66,.82));box-shadow:inset 0 1px 0 rgba(255,255,255,.07),0 18px 38px rgba(0,0,0,.22)}.lt-readable-layout .lt-plain{text-shadow:0 2px 10px rgba(0,0,0,.5)}
