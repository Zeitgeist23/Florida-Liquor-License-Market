    ...
    <main className={`license-explainer-page${props.organizedSummary ? " lt-readable-layout" : ""}`}>
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .lt-summary-county-card-style .lt-card{border:1px solid rgba(112,220,255,.42)!important;border-top:2px solid var(--gold)!important;background:linear-gradient(145deg,#0b293d 0%,#082235 52%,#061b2a 100%)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.055),inset 0 -5px 14px rgba(0,0,0,.12),0 12px 26px rgba(0,0,0,.2)!important}.lt-summary-county-card-style .lt-card:hover,.lt-summary-county-card-style .lt-card:focus-within{border-color:rgba(112,220,255,.72)!important;border-top-color:#ffc13b!important;background:linear-gradient(145deg,#0e3047 0%,#0a293e 52%,#072033 100%)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 17px 31px rgba(0,0,0,.26),0 0 14px rgba(112,220,255,.1)!important;transform:translateY(-3px) scale(1.008);filter:brightness(1.025)}.lt-summary-county-card-style .lt-card li::marker{color:#70dcff}
        ...
        .lt-series-change-card::after{content:"";position:absolute;left:9%;right:9%;bottom:-8px;height:14px;border-radius:50%;background:rgba(0,0,0,.32);filter:blur(8px);z-index:-1}
        .lt-series-change-card:hover,.lt-series-change-card:focus-within{transform:translateY(-4px);border-color:#f6a700;background:radial-gradient(circle at 24% 2%,rgba(255,255,255,.11),transparent 38%),linear-gradient(150deg,#1b4b6c,#123c59);box-shadow:inset 0 1px 0 rgba(255,255,255,.12),inset 0 -8px 18px rgba(0,0,0,.13),0 4px 0 rgba(165,111,8,.72),0 20px 38px rgba(0,0,0,.32),0 0 16px rgba(246,167,0,.12)}
        .lt-series-change-card h3{margin:0 0 12px;color:var(--gold);font:700 25px/1.15 Georgia,serif;text-align:center}
        .lt-series-change-card p{margin:0;color:#eef3f6;font-size:17px;line-height:1.65}
        .lt-series-change-actions{display:flex;flex-wrap:wrap;justify-content:center;gap:10px;margin-top:22px}
        .lt-series-change-note{max-width:none;margin:18px 0 0;padding:19px 22px;border:1px solid rgba(246,167,0,.42);border-left:5px solid var(--gold);border-radius:9px;background:radial-gradient(circle at 18% 0%,rgba(255,255,255,.075),transparent 38%),linear-gradient(145deg,#184463 0%,#123955 52%,#0c2c45 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.08),inset 0 -7px 16px rgba(0,0,0,.13),0 3px 0 rgba(111,77,13,.5),0 13px 27px rgba(0,0,0,.2);color:#e6eef3;font-size:16px;line-height:1.65}
      ...
      {props.organizedSummary ? (
        <section className={`lt-shell lt-summary${props.code === "4COP Quota" ? " lt-summary-county-card-style" : ""}`} aria-label={`${props.code} license summary`}>
