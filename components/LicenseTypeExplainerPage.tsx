    ...
    <main className="license-explainer-page">
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .lt-hero h1{margin:0;color:#fff;font:700 clamp(34px,5vw,60px)/1.02 Georgia,serif;max-width:930px}.lt-straight-numeral{display:inline-block;font-family:Arial,Helvetica,sans-serif;font-style:normal;font-weight:700;line-height:1;vertical-align:baseline}
        ...
        .lt-requirement-caution{margin:16px 0 0;padding:17px 20px;border-left:4px solid var(--gold);background:linear-gradient(90deg,rgba(246,167,0,.11),rgba(255,255,255,.055));box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 8px 18px rgba(0,0,0,.12);color:#e3ebf0;font-size:14px;line-height:1.7}
        .lt-official{padding:0 0 34px}.lt-official-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-top:16px}.lt-official-grid a{position:relative;overflow:hidden;display:flex;flex-direction:column;min-height:154px;padding:21px;border:1px solid rgba(246,167,0,.42);border-top:3px solid var(--gold);border-radius:10px;background:radial-gradient(circle at 18% 0%,rgba(255,255,255,.065),transparent 34%),linear-gradient(145deg,#163e5b 0%,#113550 52%,#0b2941 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.07),inset 0 -8px 18px rgba(0,0,0,.14),0 3px 0 rgba(112,77,12,.58),0 14px 28px rgba(0,0,0,.23);color:inherit;text-decoration:none;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease,background .18s ease}.lt-official-grid a:hover,.lt-official-grid a:focus-visible{transform:translateY(-4px);border-color:#f6a700;background:radial-gradient(circle at 18% 0%,rgba(255,255,255,.095),transparent 36%),linear-gradient(145deg,#1b4a68,#123b58);box-shadow:inset 0 1px 0 rgba(255,255,255,.11),0 4px 0 rgba(150,101,8,.68),0 20px 38px rgba(0,0,0,.31),0 0 16px rgba(246,167,0,.11);outline:none}.lt-official-grid strong{color:#fff;font-size:17px;line-height:1.38}.lt-official-grid p{margin:9px 0 13px;color:#d8e3ea;font-size:14.5px;line-height:1.62}.lt-official-grid small{margin-top:auto;color:var(--gold);font-size:13px;font-weight:900;text-transform:uppercase}
        ...
        @media(max-width:850px){.lt-grid,.lt-extra,.lt-research-grid,.lt-rule-grid,.lt-official-grid{grid-template-columns:1fr}.lt-summary-compare{grid-template-columns:1fr}.lt-card-businesses ul,.lt-summary-businesses ul{grid-template-columns:1fr 1fr}.lt-summary-businesses li:first-child{grid-column:1/-1}.lt-research-grid a,.lt-official-grid a{min-height:0}.lt-band{grid-template-columns:1fr}.lt-business-image img{max-height:none;aspect-ratio:4/3}.lt-cta{align-items:flex-start;flex-direction:column}.lt-actions{justify-content:flex-start}.lt-definition p{font-size:18px}}
        @media(max-width:560px){.lt-requirement-grid{grid-template-columns:1fr}.lt-card-businesses ul,.lt-summary-businesses ul{grid-template-columns:1fr}.lt-summary-businesses li:first-child{grid-column:auto}.lt-series-meaning{align-items:flex-start;flex-direction:column;gap:3px}}
      `}</style>
      ...
      {props.organizedSummary ? (
        <section className="lt-shell lt-summary" aria-label={`${props.code} license summary`}>
          <div className="lt-summary-head"><span>At a glance</span><h2>What a {props.code} license covers</h2></div>
      ...
      {props.requirementCards?.length ? (
        <section className="lt-shell lt-requirements" aria-labelledby={`${props.code.replace(/[^a-z0-9]/gi, "-")}-requirements`}>
          <div className="lt-requirements-head">
            <div><span>Key requirements &amp; benefits</span><h2 id={`${props.code.replace(/[^a-z0-9]/gi, "-")}-requirements`}>{props.code} practical requirements</h2></div>
