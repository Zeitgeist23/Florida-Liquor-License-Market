...
export const businessQuotaListingRecords: BusinessQuotaListing[] = [
  ...
  },
  {
    ...
    businessType: "Operating pub and bar",
    businessCategory: "Bar",
    summaryBusinessType: "Bar",
    transactionType: "Business Sale",
    packagePrice: "$795,000",
    packagePriceNumber: 795_000,
    allocatedLicenseValue: "Not displayed",
    brokerName: "Market Listing",
    brokerage: "Market Listing",
    featured: false,
    listingTier: "market",
    publicationStatus: "published",
    classification: "business_package",
  },
  {
    ...
    href: "/market-data/businesses/sarasota/bar/4cop-quota",
    county: "Sarasota County",
    countyHref: "/counties/sarasota",
    licenseType: "4COP Quota",
    licenseClass: "quota",
    title: "Sarasota County Bar + 4COP Quota License",
    businessType: "Operating bar and lounge",
    businessCategory: "Bar",
    summaryBusinessType: "Bar",
    transactionType: "Business Sale",
  ...
  },
  {
    ...
    href: "/market-data/businesses/st-lucie/bar/4cop-quota",
    county: "St. Lucie County",
    countyHref: "/counties/st-lucie",
    licenseType: "4COP Quota",
    licenseClass: "quota",
    title: "St. Lucie County Bar + 4COP Quota License",
    businessType: "Operating bar",
    businessCategory: "Bar",
    summaryBusinessType: "Bar",
    transactionType: "Business Sale",
  ...
  },
  {
    ...
    href: "/market-data/businesses/broward/restaurant/4cop-sfs-srx",
    county: "Broward County",
    countyHref: "/counties/broward",
    licenseType: "4COP SFS/SRX",
    licenseClass: "sfs",
    title: "Broward County Restaurant + 4COP SFS/SRX License",
  ...
  },
  {
    ...
    href: "/market-data/businesses/brevard/restaurant/4cop-sfs-srx",
  ...
  },
  {
    ...
    href: "/market-data/businesses/sarasota/restaurant/4cop-sfs-srx",
    county: "Sarasota County",
    countyHref: "/counties/sarasota",
    licenseType: "4COP SFS/SRX",
    licenseClass: "sfs",
    title: "Sarasota County Restaurant + 4COP SFS/SRX License",
    businessType: "Restaurant and bar",
    businessCategory: "Restaurant",
    summaryBusinessType: "Restaurant",
    transactionType: "Asset Sale",
