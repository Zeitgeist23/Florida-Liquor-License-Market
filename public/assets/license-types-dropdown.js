(() => {
  ...
  const items = [
    ...
    { label: "4COP Quota License", href: "/florida-4cop-liquor-license-for-sale" },
    { label: "3PS Quota / Package Store", href: "/florida-3ps-liquor-license-for-sale" },
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .license-types-nav-trigger::after{
        content:"";
      ...
      .license-types-header-menu::before{
        content:"";
        position:absolute;
        top:-7px;
        left:50%;
      ...
      .license-types-header-menu a:focus-visible{
        background:#f6a700;
        color:#061728;
        outline:none;
      }
      @media(max-width:899px){
        .license-types-header-menu{width:min(320px,calc(100vw - 24px))}
      }
    `;
