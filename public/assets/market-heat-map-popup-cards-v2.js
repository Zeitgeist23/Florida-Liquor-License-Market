(() => {
  const STYLE_ID = "fllm-heat-map-popup-cards-v2-styles";
  ...
  if (!document.getElementById(STYLE_ID)) {
    ...
    style.textContent = `
      ...
      .fllm-county-listings-grid{grid-template-columns:repeat(auto-fit,minmax(290px,1fr))!important;align-items:stretch!important}
      .fllm-county-listing-card{display:flex!important;flex-direction:column!important;width:100%!important;height:100%!important;min-width:0!important;overflow:hidden!important;box-sizing:border-box!important}
      .fllm-county-listing-map{width:100%!important;height:190px!important;min-height:190px!important;max-height:190px!important;display:grid!important;place-items:center!important;flex:0 0 190px!important;overflow:hidden!important;padding:10px!important;box-sizing:border-box!important;background:#061728!important}
      .fllm-county-listing-map img{display:none!important}
      .fllm-county-listing-map-svg{display:block!important;width:auto!important;height:100%!important;max-width:100%!important;max-height:100%!important;min-width:0!important;min-height:0!important;margin:auto!important;overflow:visible!important}
      .fllm-county-listing-body{display:flex!important;flex:1 1 auto!important;flex-direction:column!important;min-width:0!important;box-sizing:border-box!important}
      .fllm-county-listing-facts{display:grid!important;grid-template-columns:minmax(0,1fr)!important;align-content:center!important;gap:4px!important;min-height:58px!important;overflow:visible!important}
      .fllm-county-listing-type,.fllm-county-listing-status{display:block!important;width:100%!important;max-width:100%!important;visibility:visible!important;opacity:1!important;overflow:visible!important;white-space:normal!important;overflow-wrap:anywhere!important;text-overflow:clip!important;line-height:1.35!important}
      ...
      .fllm-county-listing-actions{margin-top:auto!important;padding-top:14px!important}
      @media(max-width:760px){.fllm-county-listings-grid{grid-template-columns:minmax(0,1fr)!important}.fllm-county-listing-map{height:175px!important;min-height:175px!important;max-height:175px!important;flex-basis:175px!important}}
    `;
  ...
  function normalizeFacts(card) {
    ...
    if (!type) { type = document.createElement("span"); facts.prepend(type); }
    type.className = "fllm-county-listing-type";
    if (!(type.textContent || "").trim()) type.textContent = deriveType(card);
    if (!status) { status = document.createElement("span"); facts.append(status); }
