(() => {
  ...
  function findCaption(section) {
    const candidates = Array.from(section?.querySelectorAll("div,p,span,strong") || [])
      .filter((element) => {
        ...
        if (element.querySelector("audio")) return false;
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      #${MODAL_ID} .market-report-popup-close{
        position:absolute;top:8px;right:10px;z-index:5;width:34px;height:34px;display:grid;place-items:center;
      ...
      #${MODAL_ID} .market-report-popup-frame{
        position:relative;width:min(100%,calc((80vh - 94px) * 1.7882653061));
        max-height:100%;aspect-ratio:701/392;flex:0 1 auto;overflow:hidden;
        border:1px solid rgba(246,167,0,.72);border-radius:8px;background:#000
      }
      #${MODAL_ID} .market-report-popup-reference{
        position:absolute;inset:0;width:100%;height:100%;display:block;object-fit:fill
      }
      #${MODAL_ID} .market-report-popup-caption-host{
        position:absolute;left:3.5%;right:3.1%;bottom:18.5%;min-height:12.6%;
      ...
      #${MODAL_ID} .market-report-popup-audio-host{
        position:absolute;left:2.8%;right:2.4%;bottom:2.6%;height:12.5%;
      ...
      @media(max-width:760px){
        ...
        #${MODAL_ID} .market-report-popup-frame{width:min(100%,calc((80vh - 72px) * 1.7882653061))}
  ...
  function openPopup(trigger) {
    ...
    reference.className = "market-report-popup-reference";
    reference.src = IMAGE_SRC;
    reference.alt = "Florida Liquor License Market Report studio";
    ...
    frame.append(reference, captionHost, audioHost);
